export const beers = [
    ...
    },
    {
        ...
        ingredients: {
            malt: [
                { name: "Maris Otter Extra Pale", amount: { value: 3.25, unit: "kilograms" } },
                { name: "Caramalt", amount: { value: 0.2, unit: "kilograms" } },
                { name: "Munich", amount: { value: 0.4, unit: "kilograms" } },
            ],
            hops: [
    ...
    },
    {
        ...
        ingredients: {
            malt: [
                ...
                { name: "Propino Pale Malt for kettle souring", amount: { value: 0.03, unit: "kilograms" } },
                { name: "Acidulated Malt for kettle souring", amount: { value: 0.03, unit: "kilograms" } },
            ],
            hops: [{ name: "Bramling Cross", amount: { value: 10, unit: "grams" }, add: "middle", attribute: "bitter" }],
            yeast: "Wyeast 1056 - American Ale™",
        },
    ...
    },
    {
        ...
        ingredients: {
            malt: [
                ...
                { name: "Carafa Special Malt Type 1", amount: { value: 0.25, unit: "kilograms" } },
            ],
            hops: [
    ...
    },
    {
        ...
        ingredients: {
            malt: [
                { name: "Maris Otter Extra Pale", amount: { value: 3.44, unit: "kilograms" } },
                { name: "Caramalt", amount: { value: 0.63, unit: "kilograms" } },
                { name: "Crystal 150", amount: { value: 0.31, unit: "kilograms" } },
                { name: "Carafa Special Malt Type 1", amount: { value: 0.31, unit: "kilograms" } },
                { name: "Carafa Special Malt Type 3", amount: { value: 0.31, unit: "kilograms" } },
            ],
            hops: [
    ...
    },
    {
        ...
        ingredients: {
            malt: [
                { name: "Maris Otter Extra Pale", amount: { value: 2.5, unit: "kilograms" } },
                { name: "Caramalt", amount: { value: 1.25, unit: "kilograms" } },
                { name: "Munich", amount: { value: 0.61, unit: "kilograms" } },
                { name: "Crystal 150", amount: { value: 0.28, unit: "kilograms" } },
                { name: "Dark Crystal 350-400", amount: { value: 0.2, unit: "kilograms" } },
            ],
            hops: [
    ...
    },
    {
        ...
        ingredients: {
            malt: [
                { name: "Pale Ale - Tipple", amount: { value: 11.1, unit: "kilograms" } },
    ...
    },
    {
        ...
        ingredients: {
            malt: [
                { name: "Extra Pale - Spring Blend", amount: { value: 5, unit: "kilograms" } },
                { name: "Caramalt", amount: { value: 1.25, unit: "kilograms" } },
    ...
    },
    {
        ...
        ingredients: {
            malt: [
                ...
                { name: "Carafa Special Malt Type 3", amount: { value: 0.13, unit: "kilograms" } },
            ],
            hops: [
